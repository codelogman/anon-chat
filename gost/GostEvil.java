 ...
 *
 * @author Alex_Strange
 * To Create object of class GostEvil-12 used public constructor with one parameters:
 * lenght of out hash-function. GostEvil-12 support 256 bit or 512 bit lenght hash.
 * Example:
 * for test example with message:
 * int[] hashOfMessage = new gostevilObject.getHashFromArray(someMessage);
 *
...
public class GostEvil {
    ...
    //longitud de hashcode
    private final int outLength;

    //Constantes de la sustitución. Transformación bi-lineal no lineal del conjunto de vectores binarios
    ...
    //Constantes de una transformación lineal de un conjunto de vectores binarios.
    ...
    //constructor
    public GostEvil(int sizeOfHash){
        ...
        if(sizeOfHash == 256){
            ...
            System.out.println("Error seleccionando longitud de la clave!");
        }
    }

    //copia la matriz de fuente [] a la matriz de destino [] de la posición de fuenteInicio a la posición de destinoIndex con longitud de longitud
    ...
    //array int array [] se traduce en una matriz de bits
    ...
    //copia ciega de una matriz fuente de una dimensión especificada
